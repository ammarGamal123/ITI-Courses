...
namespace Assignment5.Controllers
{
    public class CourseController : Controller
    {
        ...
        {
            var courses = context.Courses.Include(d => d.Department)
                                         .ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Course editedCrs)
        {

            ViewData["DeptList"] = context.Departments.ToList();

            if (editedCrs.Name != null)
            {
                context.Courses.Update(editedCrs);
                context.SaveChanges();
